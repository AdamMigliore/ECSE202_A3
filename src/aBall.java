...
public class aBall extends Thread {
	...
	private double KEx = 1, //kinetic energy in X
	...
	private void calculateVariables() {
		...
		if (Vy < 0 && Y <= bSize) {
			...
			Vox = theta < 90 ? Math.sqrt(2 * KEx) : -Math.sqrt(2 * KEx); // Resulting horizontal velocity; if launch angle is bigger than 90 degrees the ball is going towards the left so velocity is negative
